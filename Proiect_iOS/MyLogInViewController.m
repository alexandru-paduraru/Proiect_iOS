...
- (void)viewDidLoad
{
    ...
    [self.logInView setBackgroundColor:[UIColor colorWithPatternImage:[UIImage imageNamed:@"ios_project_bg.png"]]];
...
- (void)viewDidLayoutSubviews {
    ...
    [self.logInView.logo setFrame:CGRectMake(116.5, 70, 85, 30)];
    [self.logInView.facebookButton setFrame:CGRectMake(50, 287, 226, 40)];
